...
import { removePost, updatePost } from "../redux/actions/blogPostActions";
import { useDispatch, useSelector } from "react-redux";
function PostEdit({ _id, contentOne, contentTwo, title, category, image }) {
